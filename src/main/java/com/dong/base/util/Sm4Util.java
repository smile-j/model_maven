...
public class Sm4Util {
    ...
    public static String decryptEcb(byte [] keyData, String cipherText) {
        // 用于接收解密后的字符串
        String decryptStr = "";
        // hexString-->byte[]
        // hexString-->byte[]
    ...
    public static void main(String[] args) throws Exception{
       /* try {
        ...
        String cipher = "V7iX9sK7jNVlmuO-AhS8utxECObRa8jldKtAzau31N-NlCQhePEm6hoKKTYspzN10f1S_6t1sQpO-SYrKZt0eg";
        byte[] key = {75,-91,-3,1,-53,-122,5,-15,-3,1,-4,1,12,-1,86,97};

        byte [] srcData = decrypt_Ecb_Padding(key, cipher.getBytes("UTF-8"));
        // byte[]-->String
